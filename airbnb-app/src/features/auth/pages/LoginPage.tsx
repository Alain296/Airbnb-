    ...
    <div style={{
      ...
      <div style={{ flex: 1, display: 'flex' }}>
        ...
        <div style={{
          ...
          <button
            type="button"
            onClick={() => alert('Apple Sign-In requires an Apple Developer account. Configure it in .env to enable.')}
            style={{
              width: '100%', background: '#1a1a1a', color: 'white',
              border: 'none', borderRadius: 10, padding: '17px 20px',
          ...
          <a
            ...
            style={{
              width: '100%', background: '#f3f4f6', color: '#1a1a1a',
              border: 'none', borderRadius: 10, padding: '17px 20px',
              fontSize: 16, fontWeight: 500, cursor: 'pointer',
